...
<head>
<meta charset="UTF-8">
    <title>Pizza Home Template</title>
    <link rel="stylesheet" type="text/css" href="css/Pizzawebsite.css">
			...
			<div class="container-box">
				<div class="c-mainbox">
					<div class="container-img">
						<img src="images/b1.png" alt="box1">
					</div>
				...
				<div class="c-mainbox">
					<div class="container-img">
						<img src="images/b2.png" alt="box2">
					</div>
					<div class="container-text">
						<p>Fresh Tomatoes</p>
					</div>
				...
				<div class="c-mainbox">
					<div class="container-img">
						<img src="images/b3.png" alt="box3">
					</div>
					<div class="container-text">
						<p>Alpine Cheese</p>
					</div>
				...
				<div class="c-mainbox">
					<div class="container-img">
						<img src="images/b4.png" alt="box4">
					</div>
					<div class="container-text">
						<p>Italian Sausage</p>
					</div>
	...
	<!-- menu section -->
		...
		<section class="menu" id="menu">
			...
			<div class="menu-content">
				<div class="row">
					<img src="images/m1.jpg" alt="main-product1">
					<div class="menu-text">
						<div class="menu-left">
							<h4>Margarita</h4>
						</div>
				...
				<div class="row">
					<img src="images/m2.jpg" alt="main-product2">
					<div class="menu-text">
						<div class="menu-left">
							<h4>Montanara</h4>
						</div>
				...
				<div class="row">
					<img src="images/m3.jpg" alt="main-product3">
					<div class="menu-text">
						<div class="menu-left">
							<h4>Con Carne</h4>
						</div>
				...
				<div class="row">
					<img src="images/m4.jpg" alt="main-product4">
					<div class="menu-text">
						<div class="menu-left">
							<h4>Pepperoni</h4>
						</div>
